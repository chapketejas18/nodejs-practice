...
router
    .route("/mockdata/:id")
    .get(validationParams_1.validateIdParam, mockDataController_1.default.getDataById)
    .delete(validationParams_1.validateIdParam, mockDataController_1.default.deleteDataById)
    .put(validationParams_1.validateIdParam, mockDataController_1.default.updateDataById);
